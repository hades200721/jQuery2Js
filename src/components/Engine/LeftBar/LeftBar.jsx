	...
	render() {
		return <div ref="slider" className="z2 flex flex-column left-panel">
			<div className="flex-auto overflow-hidden">
				...
				<DropDown title="Advanced setting" options={[{ key: 'EnableBasicAutocomplete', label: 'Basic Autocomplete' },
				{ key: 'EnableSnippets', label: 'Enable Snippets' }, { key: 'FontSize', label: 'Font Size' },
				{ key: 'FileSize', label: 'File Size' }, { key: 'Theme', label: 'Theme' }]}> </DropDown>
			</div>
